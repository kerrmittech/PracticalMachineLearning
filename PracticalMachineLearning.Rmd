...
The data used is from the study: *Velloso, E.; Bulling, A.; Gellersen, H.; Ugulino, W.; Fuks, H. Qualitative Activity Recognition of Weight Lifting Exercises. Proceedings of 4th International Conference in Cooperation with SIGCHI (Augmented Human '13) . Stuttgart, Germany: ACM SIGCHI, 2013.*

#Loading The Data
The first step is to load all of the necessary R Packages.
...
Next, I will go ahead and load the data provided within the training and testing data files to build our model. The goal of the model is to use any variables provided to predict the manner in which a person did the exercise (classe). Please note, this assumes you have the two necessary files in your working directory, which are available at http://d396qusza40orc.cloudfront.net/predmachlearn/pml-training.csv and http://d396qusza40orc.cloudfront.net/predmachlearn/pml-testing.csv.
...
##Cleaning Up Training Data Sets
```{r}
